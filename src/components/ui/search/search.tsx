    ...
    <form action="/search" method="get" className='w-full flex flex-col gap-4'>
      ...
      <div  className="bg-gray-50 relative flex items-center w-full">
        ...
        <input
          ...
          className="bg-transparent focus:bg-transparent z-10 pl-10 block w-full rounded-md border-0 py-1.5 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
